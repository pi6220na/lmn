...
urlpatterns = [
    ...
    url(r'^venues/delete/$', views_venues.delete_venue, name='delete_venue'),
    ...
    url(r'^notes/edit/(?P<note_pk>\d+)/$', views_notes.edit_note, name='edit_note'),
    ...
    url(r'^artists/delete/$', views_artists.delete_artist, name='delete_artist'),

    # User related
    url(r'^user/profile/(?P<user_pk>\d+)/$', views_users.user_profile, name='user_profile'),
    #url(r'^user/profile/$', views_users.user_profile, name='user_profile'),
    #url(r'^user/profile/$', views_users.edit_user_profile, name='edit_user_profile'),
    url(r'^user/profile/edit/(?P<user_pk>\d+)/$', views_users.edit_user_profile, name='edit_user_profile'),
